...
short_description: 'L''été est là et notre numéro 151 (juillet-août) aussi ! A la
  ...
  entretien sur la sobriété avec Agnès Sinaï, penseuse de l’Anthropocène, plongez
  dans les émotions, moteurs de combats, rencontrez la slameuse Joëlle Sambi, des
  professeurs en hautes écoles qui cherchent comment enseigner de façon juste les
  bouleversements socio-environnementaux, ou encore Charlotte Puiseux qui lutte contre
  le validisme, partez au Sahel, où l''adaptation au changement climatique atteint
  ses limites, voyagez en slow touristes... Bonne lecture !
